...
public class Product {
	 ...
	 */
	public Product(String nombre, String descripcion, double precio, String usuario, int cantidad) {
		this.nombre = nombre;
	...
	public String toString() {
		return "Producto " + codigo + ", nombre=" + nombre + ", descripcion=" + descripcion + ", precio="
